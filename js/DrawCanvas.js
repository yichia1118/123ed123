            ...
            case 'LinePoint':
                ...
                if (str == null) {
                    ...
                    if (Points[0].X == Points[1].X) {
                        ...
                        cxt.moveTo(obj.Left * scale + (obj.Width / 2), obj.Top * scale);
                        cxt.lineTo((obj.Left + vect.X) * scale + (obj.Width / 2), (obj.Top + vect.Y) * scale);
                        ...
                        cxt.moveTo(obj.Left * scale, obj.Top * scale + (obj.Height / 2));
                        cxt.lineTo((obj.Left + vect.X) * scale, (obj.Top + vect.Y) * scale + (obj.Height / 2));
                    } else {
                        // 斜線
                        cxt.moveTo(Points[0].X * scale, Points[0].Y * scale);
                        cxt.lineTo(Points[1].X * scale, Points[1].Y * scale);
