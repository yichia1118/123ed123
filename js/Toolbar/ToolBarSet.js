                                ...
                                switch ($(this).attr('FormatterType').split('.').pop()) {
                                    ...
                                    case 'VideoObjectFormatter':
                                        ebookjson = {
                                            ...
                                            page: page,
                                            type: 'file',
                                            fileName: $(this).attr('VideoFileName'),
                                            file: $(this).attr('File'),
                                            width: $(this).attr('BoundaryPoint.Bounds.Size.Width'),
                                            height: $(this).attr('BoundaryPoint.Bounds.Size.Height'),
                                            top: $(this).attr('BoundaryPoint.Bounds.Location.Y'),
...
function operatingTrunPage(number) {
    switch (number) {
        case 1:
            $('#operating-img1').css('display', 'none');
            $('#operating-img2').css('display', 'block');
            $('#operating-img3').css('display', 'none');
            break;
        case 2:
            $('#operating-img1').css('display', 'none');
            $('#operating-img2').css('display', 'none');
            $('#operating-img3').css('display', 'block');
            break;
        case 3:
            $('#operating-img1').css('display', 'none');
            $('#operating-img2').css('display', 'none');
...
function operatingPCTrunPage(number) {
    switch (number) {
        case 1:
            $('#operating-pc-img1').css('display', 'none');
            $('#operating-pc-img2').css('display', 'block');
            $('#operating-pc-img3').css('display', 'none');
            break;
        case 2:
            $('#operating-pc-img1').css('display', 'none');
            $('#operating-pc-img2').css('display', 'none');
            $('#operating-pc-img3').css('display', 'block');
            break;
        case 3:
            $('#operating-pc-img1').css('display', 'none');
            $('#operating-pc-img2').css('display', 'none');
